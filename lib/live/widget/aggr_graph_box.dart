          ...
          Row(mainAxisAlignment: MainAxisAlignment.start, children: [
            ...
            Expanded(
              ...
              liveAgenda.reactionHappy > 0
                  ? _buildReactionsIcon(
                      'assets/images/smile-face.gif', liveAgenda.reactionHappy)
                  : Container(),
              const SizedBox(width: 10),
              liveAgenda.reactionAngry > 0
                  ? _buildReactionsIcon(
                      'assets/images/angry-face.gif', liveAgenda.reactionAngry)
                  : Container(),
              const SizedBox(width: 10),
              liveAgenda.reactionLove > 0
                  ? _buildReactionsIcon(
                      'assets/images/love-face.gif', liveAgenda.reactionLove)
                  : Container(),
              const SizedBox(width: 10),
              liveAgenda.reactionSad > 0
                  ? _buildReactionsIcon(
                      'assets/images/sad-face.gif', liveAgenda.reactionSad)
                  : Container(),
              const SizedBox(width: 10),
